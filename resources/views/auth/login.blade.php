        ...
        <div class="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-sm border border-gray-100 w-full max-w-md mx-auto"
            ...
            <form action="{{ route('login') }}" method="POST" @submit="loading = true">
                ...
                <div class="flex flex-col items-end mb-6">
                    <a href="{{ route('password.request') }}" class="text-[11px] text-amber-700 font-bold hover:underline mb-2">Lupa Password?</a>
                ...
                <p class="text-center text-sm text-gray-400">
                    Belum punya akun? 
                    <a href="{{ route('register') }}" class="text-amber-700 font-bold hover:underline">Daftar Sekarang</a>
                </p>
            </form>
        </div>
    </div>
