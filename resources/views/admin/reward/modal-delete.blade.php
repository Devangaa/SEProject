...
<template x-teleport="body">
    <div x-show="showDeleteModal" 
        ...
        <div @click.away="showDeleteModal = false" 
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">Hapus Reward?</h3>
            <p class="text-gray-500 text-sm mb-8 leading-relaxed">Apakah anda yakin ingin menghapus reward ini? Anda dapat memulihkannya nanti di tab Terhapus.</p>
            ...
            <div class="flex flex-col gap-3">
                ...
                <button @click="showDeleteModal = false" type="button" class="w-full bg-gray-100 hover:bg-gray-200 text-gray-600 font-bold py-4 rounded-2xl transition-all active:scale-95">
                    Batal
                </button>
            </div>
        </div>
