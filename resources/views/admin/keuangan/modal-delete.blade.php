...
<template x-teleport="body">
    <div x-show="showDeleteModal" 
        ...
        <div @click.away="showDeleteModal = false" 
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">Hapus Laporan Keuangan?</h3>
            <p class="text-gray-500 text-sm mb-8 leading-relaxed">Laporan keuangan ini akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.</p>
