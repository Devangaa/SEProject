            ...
            <form :action="editUrl" method="POST" enctype="multipart/form-data" class="p-8"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                    <div class="md:col-span-2 space-y-4">
                                ...
                                <div class="relative group aspect-square rounded-2xl overflow-hidden border-2 transition-all"
                                    ...
                                    <div class="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/40 transition-all">
                                        <button type="button" @click="toggleExistingImage(img)" 
                                                ...
                                                :class="removedImages.includes(img) ? 'bg-amber-500 text-white' : 'bg-red-500 text-white'">
                        ...
                        <div class="mt-4 space-y-3">
                            ...
                            <div class="grid grid-cols-4 gap-4">
                                <template x-for="(photo, index) in newPhotos" :key="'new-'+index">
                                    <div class="relative aspect-square rounded-2xl overflow-hidden border-2 border-amber-500">
                        ...
                        <p class="text-[10px] text-gray-400 font-medium">
                            * Bingkai <span class="text-red-500">Merah</span>: Akan dihapus. Bingkai <span class="text-amber-500">Hijau</span>: Foto baru.
                        </p>
                    </div>
                    ...
                    <div class="space-y-2 text-left">
                        ...
                        <input type="text" name="nama_produk" x-model="editData.nama_produk" required 
                            class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-500 transition outline-none text-sm @error('nama_produk') ring-2 ring-red-500 @enderror">
                    </div>
             ...
             x-transition:leave-end="opacity-0"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="harga" min="0" :value="Math.floor(editData.harga)" @input="editData.harga = $event.target.value" step="1" required 
                            class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-500 transition outline-none text-sm @error('harga') ring-2 ring-red-500 @enderror">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="jumlah_stok" min="0" x-model="editData.jumlah_stok" required 
                            class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-500 transition outline-none text-sm @error('jumlah_stok') ring-2 ring-red-500 @enderror">
                    </div>
             ...
             x-transition:leave-end="opacity-0"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="berat" min="0" x-model="editData.berat" class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-500 transition outline-none text-sm">
                    </div>

                    <div class="md:col-span-2 space-y-2">
                        <label class="text-sm font-bold text-gray-700 ml-1">Deskripsi</label>
                        <textarea name="deskripsi" rows="3" x-model="editData.deskripsi" class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-500 transition outline-none text-sm resize-none"></textarea>
                    </div>
                </div>
