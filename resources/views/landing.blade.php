...
<div class="w-full">
    ...
    <section id="hero" class="max-w-6xl mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center gap-12">
        <div data-aos="fade-right" class="flex-1 text-left">
            <span class="inline-block px-4 py-1.5 bg-amber-100 text-amber-800 text-xs font-bold rounded-full mb-6">
                HydroMart
            </span>
            <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-6">
                Platform Untuk Kebutuhan <span class="text-amber-700">Hidroponik</span> Anda
            </h1>
            ...
            <div class="flex gap-4">
                @if (Auth::check())
                    <a href="{{ route('produk.index') }}" class="px-8 py-4 bg-amber-700 text-white font-bold rounded-xl hover:bg-amber-800 transition shadow-lg shadow-amber-200">
                        Mulai Sekarang
                    </a>
                @else
                    <a href="{{ route('login') }}" class="px-8 py-4 bg-amber-700 text-white font-bold rounded-xl hover:bg-amber-800 transition shadow-lg shadow-amber-200">
                        Mulai Sekarang
                    </a>
                @endif
            </div>
        ...
        <div data-aos="fade" class="flex-1 flex justify-center md:justify-end">
            <div class="relative w-full max-w-[420px] aspect-square bg-amber-50 rounded-[3rem] border-8 border-white shadow-2xl shadow-amber-100/50 overflow-hidden group">
                ...
                <div class="absolute bottom-8 right-8 bg-white/95 backdrop-blur-sm px-5 py-3 rounded-2xl shadow-xl border border-white flex items-center gap-2 animate-bounce-slow">
                    <div class="flex -space-x-2">
                        <div class="w-6 h-6 rounded-full bg-amber-500 border-2 border-white flex items-center justify-center text-[10px] text-white font-bold shadow-sm">✓</div>
                    </div>
                    <span class="text-amber-800 font-extrabold text-sm tracking-tight">+500 Produk Terjual</span>
                </div>

                <div class="absolute -top-10 -left-10 w-32 h-32 bg-amber-200/30 rounded-full blur-3xl"></div>
            </div>
        </div>
    ...
    {{-- Bagian: Statistik --}}
    <section data-aos="fade-up" class="bg-amber-100 py-12">
        <div class="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center">
                <h3 class="text-3xl font-extrabold text-amber-900">50+</h3>
                <p class="text-gray-400 text-xs mt-2 font-medium">Produk Selada Hidroponik</p>
            </div>
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center">
                <h3 class="text-3xl font-extrabold text-amber-900">500+</h3>
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center">
                <h3 class="text-3xl font-extrabold text-amber-900">99%</h3>
    ...
    <section data-aos="fade-up" id="tentang" class="max-w-6xl mx-auto px-4 py-24 flex flex-col-reverse md:flex-row items-center gap-20">
        <div class="flex-1">
            <div class="w-full aspect-square bg-amber-50 rounded-[3rem] border-2 border-amber-100/50 p-6 md:p-12 flex items-center justify-center overflow-hidden">
        ...
        <div class="flex-1 text-left">
            ...
            <ul class="space-y-4">
                <li class="flex items-center gap-3 text-sm font-medium text-gray-700 italic">
                    <span class="w-5 h-5 bg-amber-500 rounded-full flex items-center justify-center text-white text-[10px]">✓</span> Belanja Produk dengan Sekali Klik
                </li>
                <li class="flex items-center gap-3 text-sm font-medium text-gray-700 italic">
                    <span class="w-5 h-5 bg-amber-500 rounded-full flex items-center justify-center text-white text-[10px]">✓</span> Tampilan  yang Simpel & Ringan
                </li>
                <li class="flex items-center gap-3 text-sm font-medium text-gray-700 italic">
                    <span class="w-5 h-5 bg-amber-500 rounded-full flex items-center justify-center text-white text-[10px]">✓</span> Antarmuka User-Friendly
                </li>
            </ul>
        </div>
    </section>
    ...
    <section data-aos="fade-up" class="pt-10 pb-24">
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                <div class="text-left">
                    <span class="inline-block px-4 py-1.5 bg-amber-100 text-amber-800 text-xs font-bold rounded-full mb-4 uppercase">
                        Koleksi Produk
                    </span>
                    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight">
                        Produk <span class="text-amber-700">Terbaik</span> Kami
                    </h2>
                ...
                <div>
                    <a href="{{ route('produk.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-white border-2 border-amber-700 text-amber-700 font-bold rounded-xl hover:bg-amber-700 hover:text-white transition duration-300 shadow-lg shadow-amber-50">
                        Lihat Semua Produk
    ...
    {{-- Bagian: Keuntungan --}}
    <section data-aos="fade-up" class="bg-amber-100 py-24">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-16">
                <span class="px-4 py-1.5 bg-amber-200 text-amber-800 text-xs font-bold rounded-full mb-4 inline-block">
                    Keuntungan
                </span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-amber-100/50 flex flex-col gap-4 group hover:shadow-xl transition duration-300">
                    <div class="w-14 h-14 bg-amber-700 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-amber-200 group-hover:scale-110 transition duration-300">
    ...
    <section data-aos="fade-up" class="py-24">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-20">
                <span class="px-4 py-1.5 bg-amber-100 text-amber-800 text-xs font-bold rounded-full mb-4 inline-block">
                    Cara Kerja
                </span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 relative">
                ...
                <div class="text-center flex flex-col items-center">
                    <div class="w-16 h-16 bg-amber-700 text-white rounded-full flex items-center justify-center text-xl font-black mb-6 shadow-xl shadow-amber-200 relative z-10">
                        1
                    </div>
